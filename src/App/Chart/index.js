      ...
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart width={730} height={250} data={this.props.data}
          ...
          {this.props.referenceLine &&
            <ReferenceLine y={this.props.referenceLine} stroke={this.props.referenceLineColor || 'white'} strokeDasharray="5 5" />
          }
          {this.props.referenceLine2 &&
            <ReferenceLine y={this.props.referenceLine2} stroke={this.props.referenceLineColor2 || 'white'} strokeDasharray="5 5" />
          }
        </AreaChart>
      </ResponsiveContainer>
    )
